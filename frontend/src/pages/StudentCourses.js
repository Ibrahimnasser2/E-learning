        ...
        <header className="page-header">
          <div className="header-content">
            ...
            <p className="page-subtitle">
              Courses for your level — created by your instructors
            </p>
          </div>
        ...
        <div className="courses-section">
            {enrolledCourses.length === 0 ? (
              <div className="empty-state">
                ...
                <p>
                  When your instructor creates a Learning Platform course for your level,
                  it will appear here. Your level comes from Upload Students.
                </p>
              </div>
            ) : (
